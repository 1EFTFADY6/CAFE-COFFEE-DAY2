...
__d("QPLCore", ["QPLEvent", "QPLTimestamp", "QPLUtils", "QuickPerformanceLoggerTypes"], (function(a, b, c, d, e, f, g) {
    ...
    a = function() {
        ...
        b.markerStart = function(a, b, c, e) {
            ...
            this.getMarker(a, b) && (this.$7.warn("Duplicate QPL event: " + d("QPLEvent").getMarkerId(a) + " & instanceKey: " + b), f && (this.$7.warn("Cancelling duplicate QPL markerId: " + d("QPLEvent").getMarkerId(a) + " & instanceKey: " + b), this.markerAnnotate(a, {
                string: {
