/*1637148264,,JIT Construction: v1004745222,en_US*/
...
try {
        ...
        for (var i = 0; i < sandboxSafelist.length; i++) {
            ...
            with(this) {
                ...
                __d("URIAbstractBase", ["invariant", "FBLogger", "PHPStrictQuerySerializer", "URIRFC3986", "URISchemes", "setHostSubdomain"], (function(a, b, c, d, e, f, g) {
                    ...
                    a = function() {
                        ...
                        a.parse = function(c, d, e, f) {
                            ...
                            c.getProtocol() && !f && !c.getDomain() && b("FBLogger")("uri").warn("URI.parse: invalid URI (protocol with no domain");
                            return !0
                        };
                ...
                __d("LiveChatPluginUtils", ["UserAgent"], (function(a, b, c, d, e, f, g) {
                    ...
                    function t(a, b, c, d, e, f, g, m) {
                        c = c - l;
                        var n = j;
                        f ? e === "none" ? g === "compact" ? n = k : n = j : g === "compact" ? n = i : n = h : g === "compact" && (n = k);
                        f = n + b;
    ...
    i.src = 'https://www.facebook.com/platform/scribe_endpoint.php/?c=jssdk_error&m=' + encodeURIComponent('{"error":"LOAD", "extra": {"name":"' + e.name + '","line":"' + (e.lineNumber || e.line) + '","script":"' + (e.fileName || e.sourceURL || e.script || "sdk.js") + '","stack":"' + (e.stackTrace || e.stack) + '","revision":"1004745222","namespace":"FB","message":"' + e.message + '"}}');
